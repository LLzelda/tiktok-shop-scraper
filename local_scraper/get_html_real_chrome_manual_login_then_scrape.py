...
# Use real Chrome Default profile on macOS
...
async def scrape_all(urls):
    async with async_playwright() as p:
        ...
        print("\n🧠 Please log into TikTok manually in the opened Chrome window.")
        print("✅ Once you're fully logged in, press ENTER here to start scraping...")
        input()
